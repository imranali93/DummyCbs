...
//    }
    ...
    public ResponseEntity<CustomerDto> getCustomerSpecificDetail(@RequestParam("cnicNumber")String cnicNumber ,
                                                                 @RequestParam ("email") String email,
                                                                 @RequestParam ("accountNumber") String accountNumber)
    {
        CustomerDto customer = customerService.getCustomerDetails(cnicNumber , email , accountNumber);
        return new ResponseEntity<>(customer, HttpStatus.FOUND);
    }
